...
Dg_res=double(imread('Grade_DG_res_3DLSC_ERTM_V1.tif'))*1D-5;  % distúrbios de gravidade residuais em m2/s2 com resolução espacial normal
...
Mi0_arquivo=georasterref('RasterSize',size(Eta_res_grade),'LatitudeLimits',[lat_S_grade,lat_N_grade],'LongitudeLimits',[lon_W_grade,lon_E_grade]);
geotiffwrite('Zeta_residual_WG300_Mi0_ERTM_V1.tif',flipud(Zeta_res_grade),Mi0_arquivo)
