...
[C0,D,func_cov_ajust]=Reillycovarfit(e,n,AG_res,covariance,covdist,'no');
covdist=covdist';
R2=1 - sum((covariance - func_cov_ajust').^2)/sum((covariance - mean(covariance)).^2)
toc

figure(1);
plot(covdist,func_cov_ajust,'DisplayName','Função covariância ajustada - Reilly','LineWidth',1.5);   hold on
...
print(gcf, 'F:\DISSERTACAO\PPTE_Metodologia\GRADE\Funções covariância\Resultados\R2_reilly_GO100.jpeg', '-djpeg', '-r300');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% A function to fit the Reilly covariance function parameters.
function [C0,Dbest,func_cov_ajust]=Reillycovarfit(X,Y,G,covariance,covdist,figplease)
...
for D=Step:Step:Dmax
     covp = C0*(1-0.5*(s./D).^2).*exp(-0.5*(s./D).^2);
