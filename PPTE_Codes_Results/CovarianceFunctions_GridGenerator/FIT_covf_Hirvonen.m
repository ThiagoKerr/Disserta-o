...
[C0,D,func_cov_ajust]=hirvcovarfit(e,n,AG_res,covariance,covdist,'no');
covdist=covdist';
R2=1 - sum((covariance - func_cov_ajust').^2)/sum((covariance - mean(covariance)).^2)
toc

figure(1);
plot(covdist,func_cov_ajust,'DisplayName','Função covariância ajustada - Hirvonen','LineWidth',1.5);   hold on
...
print(gcf, 'F:\DISSERTACAO\PPTE_SegundoTeste\GRADE\Funções covariância\Resultados\GO200\R2_Hirvonen_GO200.jpeg', '-djpeg', '-r300');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [C0,Dbest,func_cov_ajust]=hirvcovarfit(X,Y,G,covariance,covdist,figplease)
